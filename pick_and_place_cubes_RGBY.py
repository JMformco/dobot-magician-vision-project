                    ...
                    if stable_color == detected_color and stable_center:
                        ...
                        if dist < stable_radius:
                            ...
                            if elapsed >= stable_duration:
                                ...
                                # drop_r = 950 if detected_color == 'red' else 850
                                # drop_r = 950 if detected_color == 'red' else: (drop_r = 850 if detected_color == 'blue' else drop_r = 200)
                                ...
                                # Pick up Sequence
                                dType.SetPTPWithLCmd(api, dType.PTPMode.PTPMOVJXYZMode, target_x, target_y, SAFE_Z, 0, CALIBRATION_RAIL_POS, isQueued=1)
                                dType.SetPTPWithLCmd(api, dType.PTPMode.PTPMOVJXYZMode, target_x, target_y, CUBE_Z, 0, CALIBRATION_RAIL_POS, isQueued=1)
                                ...
                                # Drop off Sequence
                                dType.SetPTPWithLCmd(api, dType.PTPMode.PTPMOVJXYZMode, drop_x, drop_y, SAFE_Z, 0, drop_r, isQueued=1)
                                dType.SetPTPWithLCmd(api, dType.PTPMode.PTPMOVJXYZMode, drop_x, drop_y, drop_z, 0, drop_r, isQueued=1)
